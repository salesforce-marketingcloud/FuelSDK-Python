from FuelSDK.rest import ET_CUDSupport,ET_CUDSupportRest,ET_GetSupport,ET_Get,ET_Patch,ET_Post,ET_Delete,ET_Configure,ET_Describe,ET_Perform
...
class ET_Import(ET_CUDSupport):
    ...
    def start(self):
        return ET_Perform(self.auth_stub, self.obj_type, self.props, 'start')
