...
class ET_Client(object):
    ...
    def __init__(self, config, get_server_wsdl=False, debug=False, params=None):
        self.debug = debug
        if (debug):
        ...
        self.appsignature = config.get('appsignature')

        wsdl_server_url = config.get('defaultwsdl')
        self.auth_url = config.get('authenticationurl')
